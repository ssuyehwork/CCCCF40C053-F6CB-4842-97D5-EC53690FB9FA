...
void FileSearchContentWidget::onEditFile() {
    auto selectedItems = m_fileList->selectedItems(); if (selectedItems.isEmpty()) return;
    QStringList paths; for (auto* item : std::as_const(selectedItems)) { QString p = item->data(Qt::UserRole).toString(); if (!p.isEmpty()) paths << p; }
    QSettings settings("ArcMeta", "ExternalEditor"); QString editorPath = settings.value("EditorPath").toString();
...
void UnifiedSearchWindow::loadFavorites() {
    QSettings s("ArcMeta", "FileSearchFavorites"); QStringList favs = s.value("list").toStringList();
...
void UnifiedSearchWindow::saveFavorites() {
    ...
    QSettings s("ArcMeta", "FileSearchFavorites"); s.setValue("list", favs);
}
void UnifiedSearchWindow::loadCollection() {
    QSettings s("ArcMeta", "FileSearchCollection"); QStringList coll = s.value("list").toStringList();
...
void UnifiedSearchWindow::saveCollection() {
    ...
    QSettings s("ArcMeta", "FileSearchCollection"); s.setValue("list", coll);
}
...
void UnifiedSearchWindow::addHistoryEntry(bool isPath, const QString& path) {
    ...
    QSettings s("ArcMeta", isPath ? "FileSearchHistory" : "FileSearchFilenameHistory");
...
void UnifiedSearchWindow::addSearchHistoryEntry(const QString& text) {
    ...
    QSettings s("ArcMeta", "FileSearchFilenameHistory");
...
QStringList UnifiedSearchWindow::getHistory(bool isPath) const {
    QSettings s("ArcMeta", isPath ? "FileSearchHistory" : "FileSearchFilenameHistory"); return s.value("list").toStringList();
}
void UnifiedSearchWindow::clearHistory(bool isPath) {
    QSettings s("ArcMeta", isPath ? "FileSearchHistory" : "FileSearchFilenameHistory"); s.setValue("list", QStringList());
}
void UnifiedSearchWindow::removeHistoryEntry(bool isPath, const QString& text) {
    QSettings s("ArcMeta", isPath ? "FileSearchHistory" : "FileSearchFilenameHistory"); QStringList h = s.value("list").toStringList(); h.removeAll(text); s.setValue("list", h);
}
