...
HeaderBar::HeaderBar(QWidget* parent) : QWidget(parent) {
    ...
    ToolTipOverlay::registerWidget(btnAddCenter, "新建笔记 (Ctrl+N)");
    ...
    ToolTipOverlay::registerWidget(btnTool, "工具箱 (右键快捷设置)");
    ...
    ToolTipOverlay::registerWidget(btnLock, "全局锁定");
    ...
    ToolTipOverlay::registerWidget(m_btnStayOnTop, "始终最前 (自动置顶)");
    ...
    ToolTipOverlay::registerWidget(m_btnMeta, "元数据面板 (Ctrl+I)");
    ...
    ToolTipOverlay::registerWidget(m_btnFilter, "高级筛选 (Ctrl+G)");
