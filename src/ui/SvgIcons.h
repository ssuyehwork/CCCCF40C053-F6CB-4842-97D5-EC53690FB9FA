...
namespace SvgIcons {
    inline const QMap<QString, QString> icons = {
        ...
        {"files", R"svg(<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 2H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"></path><path d="M5 4v12a3 3 0 0 0 3 3h8"></path><path d="M3 6v12a5 5 0 0 0 5 5h8"></path></svg>)svg"},
