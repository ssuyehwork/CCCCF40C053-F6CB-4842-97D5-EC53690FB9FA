...
void FileSearchWindow::initUI() {
    ...
    connect(btnCopyAll, &QToolButton::clicked, this, [this](){
        if (m_fileList->count() == 0) {
            QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✖ 结果列表为空"), this, {}, 2000);
            return;
        }
        QStringList paths;
        ...
        QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✔ 已复制全部搜索结果"), this, {}, 2000);
    });
...
void FileSearchWindow::onEditFile() {
    auto selectedItems = m_fileList->selectedItems();
    if (selectedItems.isEmpty()) {
        QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✖ 请先选择要操作的内容"), this, {}, 2000);
        return;
    }
...
void FileSearchWindow::copySelectedFiles() {
    ...
    QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip(QString("%1").arg(msg)), this);
}
...
void FileSearchWindow::onDeleteFile() {
    ...
    if (successCount > 0) {
        ...
        QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✖ 无法删除文件，请检查是否被占用"), this);
    }
}

void FileSearchWindow::onMergeFiles(const QStringList& filePaths, const QString& rootPath) {
    if (filePaths.isEmpty()) {
        QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✖ 没有可合并的文件"), this, {}, 2000);
        return;
    }
    ...
    if (!outFile.open(QIODevice::WriteOnly | QIODevice::Text)) {
        QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✖ 无法创建输出文件"), this, {}, 2000);
        return;
    }
    ...
    QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip(QString("%1").arg(msg)), this, {}, 3000);
}
...
void FileSearchWindow::onMergeSelectedFiles() {
    ...
    if (paths.isEmpty()) {
        QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✖ 选中项中没有支持的文件类型"), this, {}, 2000);
        return;
    }
...
void FileSearchWindow::onMergeFolderContent() {
    ...
    if (filePaths.isEmpty()) {
        QToolTip::showText(QCursor::pos(), StringUtils::wrapToolTip("✖ 文件夹中没有支持的文件类型"), this, {}, 2000);
        return;
    }
