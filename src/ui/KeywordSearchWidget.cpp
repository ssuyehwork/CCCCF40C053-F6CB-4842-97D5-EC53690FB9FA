...
void KeywordSearchWidget::onEditFile() {
    ...
    QSettings settings("ArcMeta", "ExternalEditor");
    ...
    (void)QtConcurrent::run([this, rootDir, keyword, replaceText, filter, caseSensitive]() {
        ...
        QMetaObject::invokeMethod(this, [this, modifiedFiles]() {
            ...
            ToolTipOverlay::instance()->showText(QCursor::pos(), 
                StringUtils::wrapToolTip(QString("<b style='color: #2ecc71;'>[OK] 已修改 %1 个文件</b>")
                .arg(modifiedFiles)));
        });
    });
}
...
void KeywordSearchWidget::onUndo() {
    ToolTipOverlay::instance()->showText(QCursor::pos(), StringUtils::wrapToolTip("<b style='color: #e74c3c;'>[ERR] 此版本已移除备份与撤销功能！</b>"));
}
