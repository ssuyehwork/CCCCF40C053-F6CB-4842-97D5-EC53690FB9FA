...
void ShortcutManager::initDefaults() {
    ...
    add("qw_favorite", "切换书签状态", "Ctrl+E", "快速笔记窗口");
    add("qw_preview", "快速预览内容", "Space", "快速笔记窗口");
    add("qw_pin", "置顶/取消置顶项目", "Ctrl+P", "快速笔记窗口");
    ...
    add("qw_lock_cat", "立即锁定当前分类", "Ctrl+Shift+L", "快速笔记窗口");
    ...
    add("qw_copy_tags", "复制标签", "Ctrl+Shift+C", "快速笔记窗口");
    add("qw_paste_tags", "粘贴标签", "Ctrl+Shift+V", "快速笔记窗口");
    for (int i = 0; i <= 5; ++i) {
        add(QString("qw_rating_%1").arg(i), QString("设置星级 %1").arg(i), QString("Ctrl+%1").arg(i), "快速笔记窗口");
    }
